...
export function AppHeader({ backLink, subtitle, actions }: AppHeaderProps) {
  return (
    <header className="max-w-screen-2xl mx-auto w-full min-w-0 border-b border-gray-200 px-4 sm:px-8 py-4 flex items-center justify-between gap-3 sticky top-0 bg-gray-50/95 backdrop-blur-sm z-30 dark:border-gray-800 dark:bg-gray-950/95">
